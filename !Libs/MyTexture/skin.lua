    ...
    modSkin = function(self, offset)
        ...
        for i = 1, 8 do
            ...
            x:SetTexture('Interface\\AddOns\\!Libs\\MyTexture\\texture\\border-'..section..'.tga')
            t[sections[i]] = x
        end
        ...
        t.BOTTOM:SetPoint('BOTTOMLEFT', t.BOTTOMLEFT, 'BOTTOMRIGHT', 0, -1)
        t.BOTTOM:SetPoint('BOTTOMRIGHT', t.BOTTOMRIGHT, 'BOTTOMLEFT', 0, -1)
